...
const Head = ({
...

  {
    ...
    return (
      <div>
        <div className="flex  px-20 py-6  justify-between sticky top-0 bg-slate-100 z-10 gap-16  dark:bg-gray-800 max-sm:flex ">
          <h1 className="leading-9 text-3xl ">&#60;SS/&#62;</h1>
          <div className="flex items-center ">
            <ul className="flex items-center gap-4 md:gap-9 dark:color-white-800 sm:column ">
              ...
              <div className="flex gap-2 md:gap-4 items-center cursor-pointer">
                ...
                <button
                  ...
                  className="bg-black text-white rounded-lg text-xs px-2 py-2 dark:bg-white dark:text-black max-sm:hidden"
                >
                  Download CV
                </button>
                <button
                  onClick={toggleMenu}
                  className="h-[40px] w-[40px] justify-center hidden max-sm:flex "
                >
        ...
        <div className="  justify-end dark:bg-black overflow-hidden ">
